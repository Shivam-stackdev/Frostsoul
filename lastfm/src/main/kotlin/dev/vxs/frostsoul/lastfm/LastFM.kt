...
package dev.vxs.frostsoul.lastfm
...
import dev.vxs.frostsoul.lastfm.models.LastFmError
import dev.vxs.frostsoul.lastfm.models.TokenResponse
import java.net.URI
...
object LastFM {
    ...
    const val FALLBACK_COMPAT_API_KEY = "frostsoul"
    const val FALLBACK_COMPAT_SECRET = "frostsoul"
    ...
    private fun HttpRequestBuilder.lastfmParams(
        ...
        headers.append(HttpHeaders.UserAgent, "Frostsoul (https://github.com/rukamori/Frostsoul)")
        val paramsForSig =
            mutableMapOf(
                "method" to method,
                "api_key" to apiKey,
