...
package dev.vxs.frostsoul.cast
...
private class GmsCastMediaItemConverter(
    ...
    private fun MediaInfo?.toAppMediaMetadata(mediaId: String): dev.vxs.frostsoul.models.MediaMetadata {
        val castMetadata = this?.metadata
        val title = castMetadata?.stringValue(CastMetadata.KEY_TITLE) ?: mediaId
        val artistText =
        ...
        return dev.vxs.frostsoul.models.MediaMetadata(
            ...
            album =
                albumTitle?.let {
                    dev.vxs.frostsoul.models.MediaMetadata.Album(
                        id = it,
                        title = it,
                    )
                },
    ...
    private fun openResolvedRemoteSource(
        ...
        val connection =
            (URL(resolvedUri.toString()).openConnection() as HttpURLConnection).apply {
                ...
                setRequestProperty("User-Agent", "Frostsoul Cast")
