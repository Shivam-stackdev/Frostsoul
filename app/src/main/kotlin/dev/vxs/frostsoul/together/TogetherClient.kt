...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: dev.vxs.frostsoul.together.JoinDecision,
    ) : TogetherClientEvent

    data class HostTransferred(
        val transfer: dev.vxs.frostsoul.together.HostTransferred,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: dev.vxs.frostsoul.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is dev.vxs.frostsoul.together.JoinDecision -> {
                            ...
                            is dev.vxs.frostsoul.together.HostTransferred -> {
                                if (message.sessionId == sessionId) {
