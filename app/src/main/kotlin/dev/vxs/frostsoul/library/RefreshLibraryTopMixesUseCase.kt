...
package dev.vxs.frostsoul.library
...
import dev.vxs.frostsoul.ai.AiTextService
...
import dev.vxs.frostsoul.repository.LibraryTopMixRepository
        ...
        private suspend fun requestAiMixes(
            ...
            val response =
                AiTextService.complete(
                    ...
                    systemPrompt =
                        """
                        You are a music curator for Frostsoul.
...
private fun List<dev.vxs.frostsoul.innertube.models.Artist>.matchesAnyLocalArtist(song: Song): Boolean {
