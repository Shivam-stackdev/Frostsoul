...
import dev.vxs.frostsoul.App
import dev.vxs.frostsoul.BuildConfig
import dev.vxs.frostsoul.constants.CanaryReleasesEtagKey
import dev.vxs.frostsoul.constants.CanaryReleasesFingerprintKey
import dev.vxs.frostsoul.constants.CanaryReleasesJsonKey
import dev.vxs.frostsoul.constants.CanaryReleasesLastCheckedAtKey
import dev.vxs.frostsoul.constants.GitHubReleasesEtagKey
import dev.vxs.frostsoul.constants.GitHubReleasesFingerprintKey
import dev.vxs.frostsoul.constants.GitHubReleasesJsonKey
import dev.vxs.frostsoul.constants.GitHubReleasesLastCheckedAtKey
...
object Updater {
    ...
    private const val StableReleaseBaseUrl = "https://github.com/rukamori/Frostsoul/releases"
    ...
    private suspend fun fetchReleasesNetwork(
        ...
        val response: HttpResponse =
            client.get("https://api.github.com/repos/rukamori/Frostsoul/releases?per_page=$perPage") {
                headers {
                    append("Accept", "application/vnd.github+json")
                    append("User-Agent", "Frostsoul")
    ...
    suspend fun getCommitHistory(
        ...
        runCatching {
            ...
            val response =
                client
                    .get("https://api.github.com/repos/rukamori/Frostsoul/commits?sha=$branch&per_page=$count")
                    .bodyAsText()
