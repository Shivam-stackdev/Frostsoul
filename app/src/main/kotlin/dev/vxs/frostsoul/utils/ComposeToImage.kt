...
import dev.vxs.frostsoul.ui.component.LyricsShareImageOptions
import java.io.File
...
object ComposeToImage {
    ...
    suspend fun createLyricsImage(
        ...
        glassStyle: dev.vxs.frostsoul.ui.component.LyricsGlassStyle? = null,
        shareOptions: LyricsShareImageOptions = LyricsShareImageOptions(),
    ): Bitmap =
        withContext(Dispatchers.Default) {
            val style = glassStyle ?: dev.vxs.frostsoul.ui.component.LyricsGlassStyle.FrostedDark
        ...
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            val contentValues =
                ContentValues().apply {
                    ...
                    put(MediaStore.MediaColumns.RELATIVE_PATH, Environment.DIRECTORY_PICTURES + "/Frostsoul")
                }
            val uri =
