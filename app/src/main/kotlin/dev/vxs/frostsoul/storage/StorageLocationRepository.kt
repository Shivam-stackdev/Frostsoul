...
package dev.vxs.frostsoul.storage
...
import dev.vxs.frostsoul.constants.GitHubContributorsEtagKey
import dev.vxs.frostsoul.constants.GitHubContributorsJsonKey
import dev.vxs.frostsoul.constants.GitHubContributorsLastCheckedAtKey
import dev.vxs.frostsoul.constants.GitHubTranslationContributorsJsonKey
import dev.vxs.frostsoul.constants.GitHubTranslationContributorsLastCheckedAtKey
import dev.vxs.frostsoul.constants.StorageFolderDisplayNameKey
import dev.vxs.frostsoul.constants.StorageFolderIdKey
import dev.vxs.frostsoul.constants.StorageFolderPathKey
import dev.vxs.frostsoul.constants.StorageFolderTreeUriKey
...
import dev.vxs.frostsoul.utils.ArtworkStorage
...
private fun File.ensureWritableDirectory(): Boolean =
    runCatching {
        ...
        val probe = File(this, ".frostsoul-storage-probe")
        probe.writeText("ok")
        probe.delete()
    }.isSuccess
...
private const val ExternalStorageRootDirectoryName = "Frostsoul"
...
private const val SavedArtworkCacheFileName = "frostsoul_saved_artworks.json"
