...
import dev.vxs.frostsoul.canvas.FrostsoulCanvas
import dev.vxs.frostsoul.constants.*
import dev.vxs.frostsoul.extensions.*
import dev.vxs.frostsoul.innertube.YouTube
import dev.vxs.frostsoul.innertube.models.YouTubeLocale
import dev.vxs.frostsoul.kugou.KuGou
import dev.vxs.frostsoul.lastfm.LastFM
import dev.vxs.frostsoul.morideobfuscator.MoriCipherConfig
...
import dev.vxs.frostsoul.ui.player.CanvasArtworkPlaybackCache
import dev.vxs.frostsoul.ui.screens.settings.ThemePalettes
import dev.vxs.frostsoul.ui.theme.ThemeSeedPalette
import dev.vxs.frostsoul.ui.theme.ThemeSeedPaletteCodec
import dev.vxs.frostsoul.utils.PreferenceStore
import dev.vxs.frostsoul.utils.ProxyUtils
import dev.vxs.frostsoul.utils.YTPlayerUtils
import dev.vxs.frostsoul.utils.MoriCipherUpdateScheduler
import dev.vxs.frostsoul.utils.clearPlaybackAuthSession
import dev.vxs.frostsoul.utils.clearPlaybackWebAuthSession
...
import dev.vxs.frostsoul.utils.toPlaybackAuthState
import okhttp3.Dns
...
class App :
    ...
    private fun initializeCriticalSync() {
        ...
        FrostsoulCanvas.initialize(BuildConfig.CANVAS_BEARER_TOKEN)
        PaxsenixLyrics.setUserAgent("Frostsoul", BuildConfig.VERSION_NAME)
