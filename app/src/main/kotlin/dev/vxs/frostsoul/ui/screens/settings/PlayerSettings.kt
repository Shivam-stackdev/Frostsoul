...
import dev.vxs.frostsoul.constants.ArtistSeparatorsKey
...
import dev.vxs.frostsoul.constants.ExternalDownloaderEnabledKey
import dev.vxs.frostsoul.constants.ExternalDownloaderPackageKey
...
import dev.vxs.frostsoul.constants.LowDataModeKey
...
import dev.vxs.frostsoul.constants.PoTokenGvsKey
import dev.vxs.frostsoul.constants.PoTokenPlayerKey
import dev.vxs.frostsoul.constants.SeekExtraSeconds
...
import dev.vxs.frostsoul.ui.component.ArtistSeparatorsDialog
import dev.vxs.frostsoul.ui.component.CrossfadeSliderPreference
...
import dev.vxs.frostsoul.ui.component.NumberPickerPreference
import dev.vxs.frostsoul.ui.component.PreferenceEntry
import dev.vxs.frostsoul.ui.component.PreferenceGroup
import dev.vxs.frostsoul.ui.component.SliderPreference
import dev.vxs.frostsoul.ui.component.SwitchPreference
import dev.vxs.frostsoul.ui.component.TagsManagementDialog
...
fun PlayerSettings(navController: NavController) {
    ...
    val isFrostsoulExtractorEnabled =
    ...
    val playerStreamClients =
        remember {
            listOf(
                ...
                PlayerStreamClient.FROSTSOUL_EXTRACTOR,
            )
        }
    ...
    val audioQualityEnabled = selectedPlayerStreamClient != PlayerStreamClient.FROSTSOUL_EXTRACTOR
    val isPlayerStreamClientEnabled =
        remember(isFrostsoulExtractorEnabled) {
            { client: PlayerStreamClient ->
                client != PlayerStreamClient.FROSTSOUL_EXTRACTOR ||
                    isFrostsoulExtractorEnabled
            }
        }
    ...
    LaunchedEffect(playerStreamClient, isFrostsoulExtractorEnabled) {
        if (
            playerStreamClient !in playerStreamClients ||
            (
                playerStreamClient == PlayerStreamClient.FROSTSOUL_EXTRACTOR &&
                    !isFrostsoulExtractorEnabled
            )
        ) {
                    ...
                    ListPreference(
                        ...
                        valueText = {
                            when (it) {
                                ...
                                PlayerStreamClient.FROSTSOUL_EXTRACTOR -> {
                                    stringResource(
                                        R.string.player_stream_client_frostsoul_extractor,
                                    )
                                }
                        ...
                        valueDescription = {
                            when (it) {
                                ...
                                PlayerStreamClient.FROSTSOUL_EXTRACTOR -> {
                                    if (isFrostsoulExtractorEnabled) {
                                        stringResource(
                                            R.string.player_stream_client_frostsoul_extractor_desc,
                                        )
                                    } else {
                                        stringResource(
                                            R.string.player_stream_client_frostsoul_extractor_login_required,
                                        )
                                    }
                                }
