...
import dev.vxs.frostsoul.extensions.toggleRepeatMode
...
import dev.vxs.frostsoul.ui.component.MediaMetadataListItem
import dev.vxs.frostsoul.ui.component.TextFieldDialog
import dev.vxs.frostsoul.ui.menu.AddToPlaylistDialog
import dev.vxs.frostsoul.ui.menu.PlayerMenu
import dev.vxs.frostsoul.ui.utils.ShowMediaInfo
import dev.vxs.frostsoul.utils.oem.SystemMediaControlResolver
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is dev.vxs.frostsoul.together.TogetherSessionState.Joined &&
            (togetherSessionState as dev.vxs.frostsoul.together.TogetherSessionState.Joined).role is dev.vxs.frostsoul.together.TogetherRole.Guest
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? dev.vxs.frostsoul.together.TogetherSessionState.Joined
                                                                val isGuest = joined?.role is dev.vxs.frostsoul.together.TogetherRole.Guest
                                                                if (isGuest) {
