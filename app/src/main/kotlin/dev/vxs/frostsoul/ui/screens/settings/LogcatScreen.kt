...
import dev.vxs.frostsoul.logcat.LogcatLevel
import dev.vxs.frostsoul.ui.utils.backToMain
import dev.vxs.frostsoul.viewmodels.LogcatEffect
import dev.vxs.frostsoul.viewmodels.LogcatScreenState
import dev.vxs.frostsoul.viewmodels.LogcatUiEntries
import dev.vxs.frostsoul.viewmodels.LogcatUiEntry
import dev.vxs.frostsoul.viewmodels.LogcatUiModel
import dev.vxs.frostsoul.viewmodels.LogcatViewModel
import dev.vxs.frostsoul.ui.component.IconButton as FrostsoulIconButton
            ...
            when (effect) {
                ...
                is LogcatEffect.Export -> {
                    val exportIntent =
                        Intent(Intent.ACTION_SEND).apply {
                            type = "text/plain"
                            clipData = ClipData.newRawUri("frostsoul-log.txt", effect.uri)
